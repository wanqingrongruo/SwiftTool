...
//  SwiftTool
//
//  Created by roni on 2021/6/9.
//  Copyright © 2021 roni. All rights reserved.
//

import UIKit

@objc public protocol WaterfallLayoutDelegate: UICollectionViewDelegate {
...
@available(*, unavailable, renamed: "WaterfallLayout.ItemRenderDirection")
public enum WaterfallLayoutItemRenderDirection { }

public extension WaterfallLayout.ItemRenderDirection {
    @available(*, unavailable, renamed: "shortestFirst")
    static let waterfallLayoutItemRenderDirectionShortestFirst = 0
    @available(*, unavailable, renamed: "leftToRight")
    static let waterfallLayoutItemRenderDirectionLeftToRight = 1
    @available(*, unavailable, renamed: "rightToLeft")
    static let waterfallLayoutItemRenderDirectionRightToLeft = 2
}
...
public let elementKindSectionHeader = "ElementKindSectionHeader"
@available(*, unavailable, renamed: "UICollectionView.elementKindSectionFooter")
public let elementKindSectionFooter = "ElementKindSectionFooter"
